...
setup(
  name = 'packagetrack',         # How you named your package folder (MyLib)
  ...
  download_url = 'https://github.com/idm2114/packagetrack/archive/v_01-6-alpha.tar.gz',    # I explain this later on
